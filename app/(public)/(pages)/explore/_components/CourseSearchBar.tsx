...
const CourseSearchBar = ({ value, onChange, onSearch }: CourseSearchBarProps) => {
  ...
  return (
    ...
    >
      ...
      <button 
        type="submit"
        className="absolute right-2 top-1/2 -translate-y-1/2 rounded-full bg-[#00aeef] px-5 py-1.5 text-[10px] font-bold uppercase tracking-widest text-white transition-all hover:bg-[#0096ce] active:scale-95"
      >
        find
      </button>
    </form>
