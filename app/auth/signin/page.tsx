...
//                   Welcome to
//                 </h1>
//                 <span className="text-[#00BCD4] text-4xl font-bold mb-2 leading-tight">GADVance</span>
//                 <p className="text-gray-400 mb-10 text-sm">
...
//                         className="text-xs font-semibold text-[#00BCD4] hover:text-[#1fe5ff] transition-colors"
//                       >
//                         Forgot Password?
//                       </Link>
//                     </div>
...
//                     type="submit"
//                     disabled={loading}
//                     className="w-full bg-[#00BCD4] hover:bg-[#1fe5ff] text-white px-8 py-4 rounded-xl text-sm font-bold transition-all shadow-lg shadow-teal-100 mt-2 active:scale-[0.98] disabled:opacity-70 disabled:cursor-not-allowed"
//                   >
...
//               <Link
//                 href="/auth/signup"
//                 className="text-[#00BCD4] font-bold hover:underline hover:text-[#1fe5ff] transition-colors"
//               >
//                 Create Account
//               </Link>
//             </p>
...
// NOTE!! THE CODE BELOW IS THE NEW SIGN IN PAGE. THE OLD ONE IS KEPT AS A REFERENCE FOR NOW. IT WILL BE DELETED ONCE THE NEW ONE IS FINALIZED.
